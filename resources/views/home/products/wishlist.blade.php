...
<section class="section">
    ...
    <div class="wishlist-item" id="wish-{{ $product->id }}">
        ...
        <div class="wishlist-actions">
            ...
            <button onclick="removeWishlist({{ $product->id }})"
                style="background:none; border:none; font-size:22px; cursor:pointer; color:var(--red-primary); display:block; margin-top:8px;"
    ...
    @empty
        <div style="text-align:center; padding:60px 0;">
            ...
            <a href="{{ route('products.index') }}" class="btn-primary" style="display:inline-block; width:auto; padding:12px 32px;">Browse Products</a>
        </div>
    @endforelse
